...
if(isset($_POST['submit'])){
	...
	$vendor_name=get_safe_value($con,$_POST['vendor_name']);
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			...
			mysqli_query($con,"insert into product(categories_id,name,mrp,price,qty,short_desc,description,meta_title,meta_desc,meta_keyword,status,image,best_seller,sub_categories_id,photo1,photo2,photo3,created_by,vendor_name,mobile) 
			
			values('$categories_id','$name','$mrp','$price','$qty','$short_desc','$description','$meta_title','$meta_desc','$meta_keyword',1,'$image','$best_seller','$sub_categories_id','$photo1','$photo2','$photo3','$idd','$vendor_name','$mobile')");
		}
		else
		{
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Product <!--<?php echo $_SESSION['id'];?>--></strong><small> Form</small></div>
							...
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" name="vendor_name" placeholder="Enter Seller Name" class="form-control" required value="<?php echo $vendor_name?>">
								</div>
