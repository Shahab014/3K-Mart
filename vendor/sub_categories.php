...
$sql="select sub_categories.*,categories.categories from sub_categories,categories where  categories.id=sub_categories.categories_id and sub_categories.created_by=$id order by sub_categories.sub_categories asc";
