				...
				<div class="card-body--">
				   <div class="table-stats order-table ov-h">
					  <table class="table">
							...
							<tbody>
								<?php
								$ress=mysqli_query($con,"SELECT users.*, o.*, ot.name as order_str_name FROM `order`  as o, users, order_status as ot WHERE o.user_id = users.id AND o.order_status = ot.id AND o.admin_verify = 1");
								...
								<tr>
									...
									<td class="product-add-to-cart"><a href="order_master_detail.php?id=<?php echo $row['id']?>"> Status</a><br/>
