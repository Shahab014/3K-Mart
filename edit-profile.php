...
$edit=$_GET["edit"];
$query1="select * from users where id='$edit'";
...
<center><table border="1" bgcolor="#FFCCFF" width="100%" height="100%">
...
<tr>
<td>NAME</td>
<td><textarea name="name" style="background-color:white; border-color:white;"><?php echo $name; ?></textarea></td>
...
<tr>
<td>MOBILE</td>
<td><textarea name="mobile" style="background-color:white; border-color:white;"><?php echo $mobile; ?></textarea></td>
...
<tr>
<td>EMAIL</td>
<td><textarea name="email" style="background-color:white; border-color:white;"><?php echo $email; ?></textarea></td>
...
<tr>
<td>PASSWORD</td>
<td><textarea name="password" style="background-color:white; border-color:white;"><?php echo $password; ?></textarea></td>
...
$edit=$_GET["edit"];
   ...
   $mobile=$_POST["mobile"];
	...
	$query="update users set name='$name',email='$email',mobile='$mobile',password='$password' where id='$edit'";
...
{
echo"<script type=\"text/javascript\">". "window.alert('Successfully Submitted');"."top.location = 'profile.php';". "</script>";
} 
}
?>
